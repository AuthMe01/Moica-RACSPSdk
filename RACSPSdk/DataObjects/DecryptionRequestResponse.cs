...
{
    public class DecryptionRequestResponse: RACResponse
    {
        [JsonPropertyName("result")] public DecryptionRequestResponseResult Result { get; set; }
    ...
    public class  DecryptionRequestResponseResult
    {
        ...
        public DecRequestSPTicket ParseSPTicket()
        {
            ...
            var ticket = JsonSerializer.Deserialize<DecRequestSPTicket>(decodeToObject);
    ...
    public class DecRequestSPTicket
    {
