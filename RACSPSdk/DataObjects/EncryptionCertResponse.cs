...
{
    public class EncryptionCertResponse : RACResponse
    {
        [JsonPropertyName("result")] public EncryptionCertResponseResult Result { get; set; }
    ...
    public class EncryptionCertResponseResult
    {
        ...
        public EncCertSPTicket ParseSPTicket()
        {
            ...
            var ticket = JsonSerializer.Deserialize<EncCertSPTicket>(decodeToObject);
